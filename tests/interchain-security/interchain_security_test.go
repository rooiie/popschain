...
import (
	...
	appConsumer "github.com/popschainlove-ventures/popschain/app"
...
// NewCoordinator initializes Coordinator with interchain security dummy provider and popschain consumer chain
